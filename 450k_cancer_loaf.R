...
wilmy=(pData(tis.data)$Tissue=="kidney")&!(pData(tis.data)$Plate=="IL005")

wilms.data=tis.data[,wilmy]
...
##Not working right now due to Kasper f'ng with package
##wilms.v.d=timp.dvmp(wilms.data[good.probes,], pData(wilms.data)$Phenotype, type="categorical",
##  qCutoff=1e-2)
